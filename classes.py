...
create three instances of the Planet class named planet_1, planet_2, and planet_3.
--print each planet object to see the __str__ method output.
--call the orbit method on each planet object and print the result.
