"""
******** SALARY TRACKING SYSTEMS FOR EMPLOYEES ********


This program helps keep track of employee information such as:
- Employee name
- Job level
- Salary

Each employee is given a starting salary based on their level 
(trainee, junior, mid-level, or senior). The program also checks 
that salary updates and promotions are valid.

The program uses Object-Oriented Programming (OOP), where:
- A class is used to create employee objects
- Each employee object stores its own data
- Getters and setters are used to safely update information
